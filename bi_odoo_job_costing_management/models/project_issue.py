...
class ProjectIssue(models.Model):
    ...
    def create(self, vals_list):
        ...
        task = super(ProjectIssue, self.with_context(context)).create(vals_list)
        return task
    ...
    kanban_state = fields.Selection([('normal', 'Normal'), ('blocked', 'Blocked'), ('done', 'Ready for next stage')], string='Kanban State',
                                    tracking=True, required=True, default='normal',
...
class ProjectTask(models.Model):
    ...
    support_id = fields.Many2one('project.issue',
        string='Project Issue',tracking=True,change_default=True)
